...
def WSL2018():
	name = 'Results/WSL2018-2019.xls'
	print('Writing to ' + name + ' ... ...')
	mr.initExcel(ROW2018, name)
...
# WSL2018()
# WSL2(ROW2015, 5, '6119.html', PATTERN2015)
# WSL2(ROW2014, 4, '1387.html', PATTERN2014)
# WSL2(ROW2014, 3, '1389.html', PATTERN2013)
